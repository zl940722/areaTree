const usa =
    [{'city': 'Abbeville', 'state': 'Louisiana'},
        ...
        {'city': 'Bailey鈥檚 Crossroads', 'state': 'Virginia'},
        ...
        {'city': 'Coeur d鈥橝lene', 'state': 'Idaho'},
        ...
        {'city': 'D鈥橧berville', 'state': 'Mississippi'},
        ...
        {'city': 'Land O鈥� Lakes', 'state': 'Florida'},
        ...
        {'city': 'Lee鈥檚 Summit', 'state': 'Missouri'},
        ...
        {'city': 'O鈥橣allon', 'state': 'Illinois'},
        {'city': 'O鈥橣allon', 'state': 'Missouri'},
        {'city': 'O鈥橦ara Township', 'state': 'Pennsylvania'},
...
const usa_json = _.uniqWith(usa, _.isEqual);


const usa_array = [];
_.map(usa_json, (value) => {
    usa_array.push(value.state);
})

const arrayList = [];
_.map(_.uniqWith(usa_array, _.isEqual), (val,key) => {
...
const amT = JSON.stringify(arrayList, null, 2)
